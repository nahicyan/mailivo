...
export function PropertiesRow({
    ...
    return [
      {
        ...
        acre: 0.5,
        images: [
          "https://via.placeholder.com/300x200/3b82f6/ffffff?text=Property+1",
        ],
        imageUrls: [
          "https://via.placeholder.com/300x200/3b82f6/ffffff?text=Property+1",
        ],
      },
      {
        ...
        acre: 0.75,
        images: [
          "https://via.placeholder.com/300x200/10b981/ffffff?text=Property+2",
        ],
        imageUrls: [
          "https://via.placeholder.com/300x200/10b981/ffffff?text=Property+2",
        ],
      },
      {
        ...
        acre: 0.6,
        images: [
          "https://via.placeholder.com/300x200/f59e0b/ffffff?text=Property+3",
        ],
        imageUrls: [
          "https://via.placeholder.com/300x200/f59e0b/ffffff?text=Property+3",
        ],
  ...
  const formatPricing = (
    property: Property
  ): { main: string; secondary?: string; crossedOut?: string } => {
    ...
    switch (pricingStyle) {
      ...
      case "askingPriceWithPayment":
        return {
          ...
          secondary:
            monthlyPayment > 0 ? `or $${monthlyPayment}/mo` : undefined,
        };
      ...
      case "discountWithPayment":
        return {
          ...
          secondary:
            monthlyPayment > 0 ? `or $${monthlyPayment}/mo` : undefined,
          crossedOut:
            discount > 0 ? `$${askingPrice.toLocaleString()}` : undefined,
        };
      ...
      >
        {propertyRows.map((propertiesInRow, rowIndex) => (
          <div
            ...
            style={{
              marginBottom:
                rowIndex < propertyRows.length - 1
                  ? `${propertySpacing}px`
                  : "0",
              textAlign: "center",
            }}
            ...
            >
              <tbody>
                <tr>
                  ...
                  {propertiesInRow.length < 3 &&
                    propertiesInRow.length === 1 && (
                      <td style={{ width: "33.333%", padding: "0" }}></td>
                    )}
                  {propertiesInRow.length < 3 &&
                    propertiesInRow.length === 2 && (
...
export const propertiesRowMetadata: EmailComponentMetadata = {
  ...
  description:
    "Display multiple properties in a horizontal row with images, addresses, and pricing. In emails, shows all properties with wrapping.",
  category: "content",
  available: true,
  defaultProps: {
    className: "",
  ...
  configFields: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: "Asking Price + Monthly Payment",
          value: "askingPriceWithPayment",
        },
        { label: "Discounted Price", value: "disPrice" },
        {
          label: "Discounted Price + Monthly Payment",
          value: "disPriceWithPayment",
        },
        { label: "Discount Amount", value: "discount" },
        {
          label: "Discount Amount + Monthly Payment",
          value: "discountWithPayment",
        },
      ],
