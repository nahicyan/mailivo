// app/src/app/dashboard/landivo/campaigns/create/components/Step5Schedule.tsx
...
export function Step5Schedule({ formData, setFormData, errors, selectedDate, setSelectedDate, properties, emailLists, templates }: Props) {
