...
export function MultiEmailTemplateSelection({ 
  formData, 
  setFormData, 
  errors, 
  templates = [], 
      ...
      <Card>
        <CardHeader>
          ...
          <div className="text-sm text-gray-600">
            Choose a template for your multi-property campaign email design.
          </div>
        </CardHeader>
      </Card>
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            {errors.emailTemplate && (
              <p className="text-sm text-red-600">{errors.emailTemplate}</p>
            )}
          </div>
              ...
              <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
                <div className="flex items-start justify-between">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => window.open(`/dashboard/templates/${selectedTemplate.id}`, '_blank')}
                  >
          ...
          {!templatesLoading && templates.length === 0 && (
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                No email templates found. Create a template to get started.
              </AlertDescription>
            </Alert>
          )}
        </CardContent>
