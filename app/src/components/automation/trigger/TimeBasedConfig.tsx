...
export function useRequiredEmailSubject(trigger: AutomationTrigger) {
  ...
  return {
    ...
    validationMessage: isRequired 
      ? "Email subject is required for time-based automations. Subject bypass is not available."
      : null
  };
}
 ...
 */
export function validateScheduleForTrigger(
  schedule: string,
  triggerType: string
      ...
      <Alert className="bg-purple-50 border-purple-200">
        ...
        <AlertDescription>
          ...
          <p className="text-sm text-purple-800 mt-1">
            Time-based triggers require multi-property campaigns to aggregate properties on schedule.
          </p>
        </AlertDescription>
      </Alert>
    </div>
    ...
    <Alert className="bg-blue-50 border-blue-200">
      ...
      <AlertDescription className="text-sm">
        ...
        <p className="text-blue-800">
          The trigger defines when campaigns run (daily/weekly/monthly). Choose when to send after the trigger fires.
        </p>
      </AlertDescription>
    </Alert>
  );
  ...
  return (
    <Alert variant="destructive">
      ...
      <AlertDescription>
        ...
        <p className="text-sm">
          Time-based triggers require property conditions to determine which properties to include in the scheduled campaign.
          Add property conditions in the conditions section.
        </p>
      </AlertDescription>
    </Alert>
  );
      ...
      <Alert className="bg-purple-50 border-purple-200">
        ...
        <AlertDescription>
          ...
          <ul className="text-sm text-purple-800 space-y-1 list-disc list-inside">
            <li>Campaign type locked to <strong>multi-property</strong></li>
            <li>Email subject <strong>required</strong> (no bypass option)</li>
